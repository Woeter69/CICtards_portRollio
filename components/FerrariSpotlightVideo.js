...
export default function FerrariSpotlightVideo({ member }) {
    ...
    // Ferrari entrance animations - delayed by ~3 seconds worth of scroll
    const ferrariProgress = useTransform(smoothProgress, [0.38, 1], [0, 1]);
    const ferrariOpacity = useTransform(smoothProgress, [0.38, 0.46], [0, 1]); // Delayed entrance
    const ferrariScale = useTransform(smoothProgress, [0.38, 0.46], [0.95, 1.0]);
